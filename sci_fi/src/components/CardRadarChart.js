...
class CardRadarChart extends Component {
  ...
  render() {
        ...
        {
            data ={
                labels: ['Alien', 'Robot', 'Dystopian', 'Fantasy', 'Monster',  'Time Travel','Space'],
                datasets: [
                    {
                        radius: 0,
