...
var topGrossing2 = [
    {
        ...
        "runtime": 162,
        "year": 2009,
        "poster": "http://image.tmdb.org/t/p/w185//kmcqlZGaSh20zpTbuoF0Cdn07dT.jpg",
        "rating": 3.9
    },
    {
        "Movie_title": "Star Wars: The Force Awakens",
        ...
        "runtime": 136,
        "year": 2015,
        "poster": "http://image.tmdb.org/t/p/w185//weUSwMdQIa3NaXVzwUoIIcAi85d.jpg",
        "rating": 4
    },
    {
        "Movie_title": "The Avengers",
        ...
        "runtime": 143,
        "year": 2012,
        "poster": "http://image.tmdb.org/t/p/w185//cezWGskPY5x7GaglTTRN4Fugfb8.jpg",
        "rating": 4.05
    },
    {
        "Movie_title": "Jurassic World",
        ...
        "runtime": 124,
        "year": 2015,
        "poster": "http://image.tmdb.org/t/p/w185//jjBgi2r5cRt36xF6iNUEhzscEcb.jpg",
        "rating": 3.5
    },
    {
        "Movie_title": "Harry Potter and the Deathly Hallows: Part 2",
        ...
        "runtime": 130,
        "year": 2011,
        "poster": "http://image.tmdb.org/t/p/w185//fTplI1NCSuEDP4ITLcTps739fcC.jpg",
        "rating": 4.05
    },
    {
        "Movie_title": "Captain America: Civil War",
        ...
        "runtime": 147,
        "year": 2016,
        "poster": "http://image.tmdb.org/t/p/w185//kSBXou5Ac7vEqKd97wotJumyJvU.jpg",
        "rating": 3.9
    },
    {
        "Movie_title": "The Lord of the Rings: The Return of the King",
        ...
        "runtime": 201,
        "year": 2003,
        "poster": "http://image.tmdb.org/t/p/w185//uexxR7Kw1qYbZk0RYaF9Rx5ykbj.jpg",
        "rating": 4.45
    },
    {
        "Movie_title": "Rogue One: A Star Wars Story",
        ...
        "runtime": 133,
        "year": 2016,
        "poster": "http://image.tmdb.org/t/p/w185//qjiskwlV1qQzRCjpV0cL9pEMF9a.jpg",
        "rating": 3.9
    },
    {
        "Movie_title": "E.T. the Extra-Terrestrial",
        ...
        "runtime": 115,
        "year": 1982,
        "poster": "http://image.tmdb.org/t/p/w185//8htLKK03TJjKZOXJgihZCu8v0P.jpg",
        "rating": 3.95
    },
    {
        "Movie_title": "Inception",
        ...
        "runtime": 148,
        "year": 2010,
        "poster": "http://image.tmdb.org/t/p/w185//qmDpIHrmpJINaRKAfWQfftjCdyi.jpg",
        "rating": 4.4
    }
];
var movies=[]
...
topGrossing2.map((node)=>{
    movie[node.imdb_id]={}
});
topGrossing2.map((node)=>{
    movie[node.imdb_id].title=node.Movie_title;
    movie[node.imdb_id].language=node.language;
    movie[node.imdb_id].overview=node.overview;
    movie[node.imdb_id].runtime=node.runtime;
    movie[node.imdb_id].year=node.year;
    movie[node.imdb_id].poster=node.poster;
    movie[node.imdb_id].rating=node.rating;

});
console.log(movie);

topGrossing.map((node)=>{

    grossingRadar[node.tconst]=[]
    tconst.push(node.tconst)
    movies.push(node.Movie_title)
    gross.push(node.revenue);
});

topGrossing.map((node)=>{
    grossingRadar[node.tconst].push(node.alien,
        node.space,
        node.robot,
        node.time_travel,
        node.super,
...
console.log(JSON.stringify(grossingRadar))

console.log(JSON.stringify(movies))
console.log(JSON.stringify(gross))
console.log(JSON.stringify(tconst))
