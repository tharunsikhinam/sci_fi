                ...
                >
                    <DialogTitle
                        ...
                        <h1 style={{paddingLeft: "36px", display: "inline"}}>
                            Sci-fi Films <div style={{display: "inline"}}
                                              className={classes.year}>({this.props.year})</div>
                        </h1>
                    ...
                    <DialogContent aria-checked={true}>
                        <DialogContentText>
                            <Collapse in={!this.state.expanded} timeout="auto" unmountOnExit>
                                <GridList allMovies={this.props.allMovies} filteredMovies={this.state.filteredMovies}
